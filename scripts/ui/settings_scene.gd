...
func update_textures() -> void:
	if Autoload.data.lang == "ru":
		...
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_normal = $Sprite1222.texture
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_hover = $Sprite1223.texture
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_pressed = $Sprite1223.texture
		...
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_normal = $Sprite1220.texture
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_hover = $Sprite1221.texture
		$MarginContainer/HBoxContainer/MarginContainer3/DeleteFile.texture_pressed = $Sprite1221.texture
